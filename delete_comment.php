...
$sql = "SELECT * FROM comments WHERE id = '$t_id'";
...
<body style="text-align:center; visibility: <?= $vis ?>">
    ...
    function yes()
    {
        ...
        $sql = "SELECT * FROM comments WHERE id = '$ptid'";
        ...
        $ptid =  $_GET['id'];
        $sql2 = "DELETE FROM `comments` WHERE `id` = $ptid";
    ...
    <button class="del-btn" onclick="window.location.href='view_post.php?id=<?= $post_id ?>';">No</button>
